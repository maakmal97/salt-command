...
field, so nothing typed can reach the order unseen. Units above one, unit at one. **Place carries the stamp of
...
one is gone; a refusal those orders explain turns the sheet to the same list.
