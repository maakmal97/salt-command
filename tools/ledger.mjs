...
const NOT_LEDGER = new Set([
  ...
  "ORD_WHY_PICK" /* S11 11.7: the reasons Decline and Cancel offer, in the words the customer reads */,
  ...
  "ledF", "ledSort", "tdRemind", "concSort", "mnOver", "pxOver",   /* v812: Today's reminder texts; v802: jrnF left with the Journal */
