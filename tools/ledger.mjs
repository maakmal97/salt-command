...
const NOT_LEDGER = new Set([
  ...
  "PRICE", "PRICE_ENGINE", "PRICING_ENGINE", "POSITION_ENGINE" /* v337, v338: the engine modules inlined by tools/engine.mjs; functions, no data */, "PRICE_TIERS", "PRICE_MODEL", "PRICE_LOCK", "PXBANDS", "PX",
